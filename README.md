### About
A simple Python LangChain application to learn how to build AI agents.

See below for notes on what I've learned.
...
### Run project
In `.env`, set your Anthorpic API key
`
...
Go to http://localhost:8000/ to and you should see {"detail":"Not Found"} if the app is running
...
Use Math, return result as ascii-art (Deepagents using a Skill)
```pwsh
